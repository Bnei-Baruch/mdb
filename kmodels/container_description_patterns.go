...
func (o *ContainerDescriptionPattern) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	...
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to upsert container_description_patterns")
	}
...
func (o *ContainerDescriptionPattern) DeleteG() error {
	if o == nil {
		return errors.New("kmodels: no ContainerDescriptionPattern provided for deletion")
	}
...
func (o *ContainerDescriptionPattern) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("kmodels: no ContainerDescriptionPattern provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to delete from container_description_patterns")
	}
...
func (q containerDescriptionPatternQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("kmodels: no containerDescriptionPatternQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to delete all from container_description_patterns")
	}
...
func (o ContainerDescriptionPatternSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("kmodels: no ContainerDescriptionPattern slice provided for delete all")
	}
...
func (o ContainerDescriptionPatternSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to delete all from containerDescriptionPattern slice")
	}
...
func (o *ContainerDescriptionPattern) ReloadG() error {
	if o == nil {
		return errors.New("kmodels: no ContainerDescriptionPattern provided for reload")
	}
...
func (o *ContainerDescriptionPatternSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("kmodels: empty ContainerDescriptionPatternSlice provided for reload all")
	}
...
func (o *ContainerDescriptionPatternSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to reload all in ContainerDescriptionPatternSlice")
	}
...
func ContainerDescriptionPatternExists(exec boil.Executor, id int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "kmodels: unable to check if container_description_patterns exists")
	}
