...
func (q catalogDescriptionQuery) One() (*CatalogDescription, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "kmodels: failed to execute a one query for catalog_descriptions")
	}
...
func (q catalogDescriptionQuery) All() (CatalogDescriptionSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "kmodels: failed to assign all query results to CatalogDescription slice")
	}
...
func (q catalogDescriptionQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "kmodels: failed to count catalog_descriptions rows")
	}
...
func (q catalogDescriptionQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "kmodels: failed to check if catalog_descriptions exists")
	}
...
// SetCatalogG of the catalog_description to the related item.
...
func (o *CatalogDescription) SetCatalogG(insert bool, related *Catalog) error {
	return o.SetCatalog(boil.GetDB(), insert, related)
}

// SetCatalogP of the catalog_description to the related item.
// Sets o.R.Catalog to related.
// Adds o to related.R.CatalogDescriptions.
// Panics on error.
func (o *CatalogDescription) SetCatalogP(exec boil.Executor, insert bool, related *Catalog) {
	if err := o.SetCatalog(exec, insert, related); err != nil {
		panic(boil.WrapErr(err))
	}
}

// SetCatalogGP of the catalog_description to the related item.
// Sets o.R.Catalog to related.
// Adds o to related.R.CatalogDescriptions.
// Uses the global database handle and panics on error.
func (o *CatalogDescription) SetCatalogGP(insert bool, related *Catalog) {
	if err := o.SetCatalog(boil.GetDB(), insert, related); err != nil {
		panic(boil.WrapErr(err))
	}
}
...
// SetLangG of the catalog_description to the related item.
...
// SetLangP of the catalog_description to the related item.
// Sets o.R.Lang to related.
// Adds o to related.R.LangCatalogDescriptions.
// Panics on error.
...
// SetLangGP of the catalog_description to the related item.
// Sets o.R.Lang to related.
// Adds o to related.R.LangCatalogDescriptions.
// Uses the global database handle and panics on error.
...
func FindCatalogDescription(exec boil.Executor, id int, selectCols ...string) (*CatalogDescription, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "kmodels: unable to select from catalog_descriptions")
	}
...
func (o *CatalogDescription) Insert(exec boil.Executor, whitelist ...string) error {
	...
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to insert into catalog_descriptions")
	}
...
func (o *CatalogDescription) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("kmodels: unable to update catalog_descriptions, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to update catalog_descriptions row")
	}
...
func (q catalogDescriptionQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to update all for catalog_descriptions")
	}
...
func (o CatalogDescriptionSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to update all in catalogDescription slice")
	}
...
func (o *CatalogDescription) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("kmodels: unable to upsert catalog_descriptions, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to upsert catalog_descriptions")
	}
...
func (o *CatalogDescription) DeleteG() error {
	if o == nil {
		return errors.New("kmodels: no CatalogDescription provided for deletion")
	}
...
func (o *CatalogDescription) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("kmodels: no CatalogDescription provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to delete from catalog_descriptions")
	}
...
func (q catalogDescriptionQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("kmodels: no catalogDescriptionQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to delete all from catalog_descriptions")
	}
...
func (o CatalogDescriptionSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("kmodels: no CatalogDescription slice provided for delete all")
	}
...
func (o CatalogDescriptionSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to delete all from catalogDescription slice")
	}
...
func (o *CatalogDescription) ReloadG() error {
	if o == nil {
		return errors.New("kmodels: no CatalogDescription provided for reload")
	}
...
func (o *CatalogDescriptionSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("kmodels: empty CatalogDescriptionSlice provided for reload all")
	}
...
func (o *CatalogDescriptionSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to reload all in CatalogDescriptionSlice")
	}
...
func CatalogDescriptionExists(exec boil.Executor, id int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "kmodels: unable to check if catalog_descriptions exists")
	}
