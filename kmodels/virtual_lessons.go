...
func (q virtualLessonQuery) One() (*VirtualLesson, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "kmodels: failed to execute a one query for virtual_lessons")
	}
...
func (q virtualLessonQuery) All() (VirtualLessonSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "kmodels: failed to assign all query results to VirtualLesson slice")
	}
...
func (q virtualLessonQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "kmodels: failed to count virtual_lessons rows")
	}
...
func (q virtualLessonQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "kmodels: failed to check if virtual_lessons exists")
	}
...
func FindVirtualLesson(exec boil.Executor, id int, selectCols ...string) (*VirtualLesson, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "kmodels: unable to select from virtual_lessons")
	}
...
func (o *VirtualLesson) Insert(exec boil.Executor, whitelist ...string) error {
	...
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to insert into virtual_lessons")
	}
...
func (o *VirtualLesson) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("kmodels: unable to update virtual_lessons, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to update virtual_lessons row")
	}
...
func (q virtualLessonQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to update all for virtual_lessons")
	}
...
func (o VirtualLessonSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to update all in virtualLesson slice")
	}
...
func (o *VirtualLesson) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("kmodels: unable to upsert virtual_lessons, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to upsert virtual_lessons")
	}
...
func (o *VirtualLesson) DeleteG() error {
	if o == nil {
		return errors.New("kmodels: no VirtualLesson provided for deletion")
	}
...
func (o *VirtualLesson) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("kmodels: no VirtualLesson provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to delete from virtual_lessons")
	}
...
func (q virtualLessonQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("kmodels: no virtualLessonQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to delete all from virtual_lessons")
	}
...
func (o VirtualLessonSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("kmodels: no VirtualLesson slice provided for delete all")
	}
...
func (o VirtualLessonSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to delete all from virtualLesson slice")
	}
...
func (o *VirtualLesson) ReloadG() error {
	if o == nil {
		return errors.New("kmodels: no VirtualLesson provided for reload")
	}
...
func (o *VirtualLessonSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("kmodels: empty VirtualLessonSlice provided for reload all")
	}
...
func (o *VirtualLessonSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to reload all in VirtualLessonSlice")
	}
...
func VirtualLessonExists(exec boil.Executor, id int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "kmodels: unable to check if virtual_lessons exists")
	}
