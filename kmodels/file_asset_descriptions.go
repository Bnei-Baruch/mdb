...
var (
	fileAssetDescriptionColumns               = []string{"id", "file_id", "filedesc", "lang", "created_at", "updated_at"}
	fileAssetDescriptionColumnsWithoutDefault = []string{"filedesc", "lang", "created_at", "updated_at"}
...
func (q fileAssetDescriptionQuery) One() (*FileAssetDescription, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "kmodels: failed to execute a one query for file_asset_descriptions")
	}
...
func (q fileAssetDescriptionQuery) All() (FileAssetDescriptionSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "kmodels: failed to assign all query results to FileAssetDescription slice")
	}
...
func (q fileAssetDescriptionQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "kmodels: failed to count file_asset_descriptions rows")
	}
...
func (q fileAssetDescriptionQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "kmodels: failed to check if file_asset_descriptions exists")
	}
...
// SetFileG of the file_asset_description to the related item.
...
func (o *FileAssetDescription) SetFileG(insert bool, related *FileAsset) error {
	return o.SetFile(boil.GetDB(), insert, related)
}

// SetFileP of the file_asset_description to the related item.
// Sets o.R.File to related.
// Adds o to related.R.FileFileAssetDescriptions.
// Panics on error.
func (o *FileAssetDescription) SetFileP(exec boil.Executor, insert bool, related *FileAsset) {
	if err := o.SetFile(exec, insert, related); err != nil {
		panic(boil.WrapErr(err))
	}
}

// SetFileGP of the file_asset_description to the related item.
// Sets o.R.File to related.
// Adds o to related.R.FileFileAssetDescriptions.
// Uses the global database handle and panics on error.
func (o *FileAssetDescription) SetFileGP(insert bool, related *FileAsset) {
	if err := o.SetFile(boil.GetDB(), insert, related); err != nil {
		panic(boil.WrapErr(err))
	}
}
...
func FindFileAssetDescription(exec boil.Executor, id int, selectCols ...string) (*FileAssetDescription, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "kmodels: unable to select from file_asset_descriptions")
	}
...
func (o *FileAssetDescription) Insert(exec boil.Executor, whitelist ...string) error {
	...
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to insert into file_asset_descriptions")
	}
...
func (o *FileAssetDescription) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("kmodels: unable to update file_asset_descriptions, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to update file_asset_descriptions row")
	}
...
func (q fileAssetDescriptionQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to update all for file_asset_descriptions")
	}
...
func (o FileAssetDescriptionSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to update all in fileAssetDescription slice")
	}
...
func (o *FileAssetDescription) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("kmodels: unable to upsert file_asset_descriptions, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to upsert file_asset_descriptions")
	}
...
func (o *FileAssetDescription) DeleteG() error {
	if o == nil {
		return errors.New("kmodels: no FileAssetDescription provided for deletion")
	}
...
func (o *FileAssetDescription) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("kmodels: no FileAssetDescription provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to delete from file_asset_descriptions")
	}
...
func (q fileAssetDescriptionQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("kmodels: no fileAssetDescriptionQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to delete all from file_asset_descriptions")
	}
...
func (o FileAssetDescriptionSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("kmodels: no FileAssetDescription slice provided for delete all")
	}
...
func (o FileAssetDescriptionSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to delete all from fileAssetDescription slice")
	}
...
func (o *FileAssetDescription) ReloadG() error {
	if o == nil {
		return errors.New("kmodels: no FileAssetDescription provided for reload")
	}
...
func (o *FileAssetDescriptionSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("kmodels: empty FileAssetDescriptionSlice provided for reload all")
	}
...
func (o *FileAssetDescriptionSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to reload all in FileAssetDescriptionSlice")
	}
...
func FileAssetDescriptionExists(exec boil.Executor, id int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "kmodels: unable to check if file_asset_descriptions exists")
	}
