...
var (
	dictionaryDescriptionColumns               = []string{"id", "dictionary_id", "topic", "lang", "created_at", "updated_at"}
	dictionaryDescriptionColumnsWithoutDefault = []string{"dictionary_id", "topic", "created_at", "updated_at"}
	dictionaryDescriptionColumnsWithDefault    = []string{"id", "lang"}
...
func (q dictionaryDescriptionQuery) One() (*DictionaryDescription, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "kmodels: failed to execute a one query for dictionary_descriptions")
	}
...
func (q dictionaryDescriptionQuery) All() (DictionaryDescriptionSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "kmodels: failed to assign all query results to DictionaryDescription slice")
	}
...
func (q dictionaryDescriptionQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "kmodels: failed to count dictionary_descriptions rows")
	}
...
func (q dictionaryDescriptionQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "kmodels: failed to check if dictionary_descriptions exists")
	}
...
func FindDictionaryDescription(exec boil.Executor, id int, selectCols ...string) (*DictionaryDescription, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "kmodels: unable to select from dictionary_descriptions")
	}
...
func (o *DictionaryDescription) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("kmodels: no dictionary_descriptions provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to insert into dictionary_descriptions")
	}
...
func (o *DictionaryDescription) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("kmodels: unable to update dictionary_descriptions, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to update dictionary_descriptions row")
	}
...
func (q dictionaryDescriptionQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to update all for dictionary_descriptions")
	}
...
func (o DictionaryDescriptionSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to update all in dictionaryDescription slice")
	}
...
func (o *DictionaryDescription) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("kmodels: unable to upsert dictionary_descriptions, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to upsert dictionary_descriptions")
	}
...
func (o *DictionaryDescription) DeleteG() error {
	if o == nil {
		return errors.New("kmodels: no DictionaryDescription provided for deletion")
	}
...
func (o *DictionaryDescription) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("kmodels: no DictionaryDescription provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to delete from dictionary_descriptions")
	}
...
func (q dictionaryDescriptionQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("kmodels: no dictionaryDescriptionQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to delete all from dictionary_descriptions")
	}
...
func (o DictionaryDescriptionSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("kmodels: no DictionaryDescription slice provided for delete all")
	}
...
func (o DictionaryDescriptionSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to delete all from dictionaryDescription slice")
	}
...
func (o *DictionaryDescription) ReloadG() error {
	if o == nil {
		return errors.New("kmodels: no DictionaryDescription provided for reload")
	}
...
func (o *DictionaryDescriptionSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("kmodels: empty DictionaryDescriptionSlice provided for reload all")
	}
...
func (o *DictionaryDescriptionSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to reload all in DictionaryDescriptionSlice")
	}
...
func DictionaryDescriptionExists(exec boil.Executor, id int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "kmodels: unable to check if dictionary_descriptions exists")
	}
