...
import (
	...
	"github.com/Bnei-Baruch/mdb/monitor/internal/metric"
)

type RunningAggregator struct {
	a      interfaces.Aggregator
...
func NewRunningAggregator(
	...
	return &RunningAggregator{
		a:       a,
		Config:  conf,
		metrics: make(chan interfaces.Metric, 100),
	}
}
...
func (r *RunningAggregator) Add(in interfaces.Metric) bool {
...
func (r *RunningAggregator) add(in interfaces.Metric) {
	r.a.Add(in)
}

func (r *RunningAggregator) push(acc interfaces.Accumulator) {
	r.a.Push(acc)
}
