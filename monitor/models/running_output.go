...
import (
	...
	"github.com/Bnei-Baruch/mdb/monitor/internal/buffer"
...
func (ro *RunningOutput) AddMetric(m interfaces.Metric) {
	if m == nil {
		return
	}
...
func (ro *RunningOutput) write(metrics []interfaces.Metric) error {
