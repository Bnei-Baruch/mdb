...
func (s *Serializer) Serialize(m interfaces.Metric) ([]byte, error) {
	s.buf.Reset()
...
func (s *Serializer) Write(w io.Writer, m interfaces.Metric) (int, error) {
...
func (s *Serializer) buildHeader(m interfaces.Metric) error {
	s.header = s.header[:0]
...
func (s *Serializer) buildFooter(m interfaces.Metric) {
	s.footer = s.footer[:0]
...
func (s *Serializer) writeMetric(w io.Writer, m interfaces.Metric) error {
	var err error
