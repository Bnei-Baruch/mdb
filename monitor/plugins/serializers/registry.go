...
import (
	...
	"github.com/Bnei-Baruch/mdb/monitor/plugins/serializers/graphite"
	"github.com/Bnei-Baruch/mdb/monitor/plugins/serializers/influx"
	"github.com/Bnei-Baruch/mdb/monitor/plugins/serializers/json"
)
...
type Serializer interface {
	...
	Serialize(metric interfaces.Metric) ([]byte, error)
}
