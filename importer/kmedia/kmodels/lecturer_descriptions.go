...
var (
	lecturerDescriptionColumns               = []string{"id", "lecturer_id", "desc", "lang", "created_at", "updated_at"}
	lecturerDescriptionColumnsWithoutDefault = []string{"created_at", "updated_at"}
	lecturerDescriptionColumnsWithDefault    = []string{"id", "lecturer_id", "desc", "lang"}
...
func (q lecturerDescriptionQuery) One() (*LecturerDescription, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "kmodels: failed to execute a one query for lecturer_descriptions")
	}
...
func (q lecturerDescriptionQuery) All() (LecturerDescriptionSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "kmodels: failed to assign all query results to LecturerDescription slice")
	}
...
func (q lecturerDescriptionQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "kmodels: failed to count lecturer_descriptions rows")
	}
...
func (q lecturerDescriptionQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "kmodels: failed to check if lecturer_descriptions exists")
	}
...
func FindLecturerDescription(exec boil.Executor, id int, selectCols ...string) (*LecturerDescription, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "kmodels: unable to select from lecturer_descriptions")
	}
...
func (o *LecturerDescription) Insert(exec boil.Executor, whitelist ...string) error {
	...
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to insert into lecturer_descriptions")
	}
...
func (o *LecturerDescription) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("kmodels: unable to update lecturer_descriptions, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to update lecturer_descriptions row")
	}
...
func (q lecturerDescriptionQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to update all for lecturer_descriptions")
	}
...
func (o LecturerDescriptionSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to update all in lecturerDescription slice")
	}
...
func (o *LecturerDescription) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("kmodels: unable to upsert lecturer_descriptions, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to upsert lecturer_descriptions")
	}
...
func (o *LecturerDescription) DeleteG() error {
	if o == nil {
		return errors.New("kmodels: no LecturerDescription provided for deletion")
	}
...
func (o *LecturerDescription) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("kmodels: no LecturerDescription provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to delete from lecturer_descriptions")
	}
...
func (q lecturerDescriptionQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("kmodels: no lecturerDescriptionQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to delete all from lecturer_descriptions")
	}
...
func (o LecturerDescriptionSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("kmodels: no LecturerDescription slice provided for delete all")
	}
...
func (o LecturerDescriptionSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to delete all from lecturerDescription slice")
	}
...
func (o *LecturerDescription) ReloadG() error {
	if o == nil {
		return errors.New("kmodels: no LecturerDescription provided for reload")
	}
...
func (o *LecturerDescriptionSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("kmodels: empty LecturerDescriptionSlice provided for reload all")
	}
...
func (o *LecturerDescriptionSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to reload all in LecturerDescriptionSlice")
	}
...
func LecturerDescriptionExists(exec boil.Executor, id int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "kmodels: unable to check if lecturer_descriptions exists")
	}
