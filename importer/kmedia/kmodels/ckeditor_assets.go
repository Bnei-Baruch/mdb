...
func (q ckeditorAssetQuery) One() (*CkeditorAsset, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "kmodels: failed to execute a one query for ckeditor_assets")
	}
...
func (q ckeditorAssetQuery) All() (CkeditorAssetSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "kmodels: failed to assign all query results to CkeditorAsset slice")
	}
...
func (q ckeditorAssetQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "kmodels: failed to count ckeditor_assets rows")
	}
...
func (q ckeditorAssetQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "kmodels: failed to check if ckeditor_assets exists")
	}
...
func FindCkeditorAsset(exec boil.Executor, id int, selectCols ...string) (*CkeditorAsset, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "kmodels: unable to select from ckeditor_assets")
	}
...
func (o *CkeditorAsset) Insert(exec boil.Executor, whitelist ...string) error {
	...
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to insert into ckeditor_assets")
	}
...
func (o *CkeditorAsset) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("kmodels: unable to update ckeditor_assets, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to update ckeditor_assets row")
	}
...
func (q ckeditorAssetQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to update all for ckeditor_assets")
	}
...
func (o CkeditorAssetSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to update all in ckeditorAsset slice")
	}
...
func (o *CkeditorAsset) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("kmodels: no ckeditor_assets provided for upsert")
	}
	currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("kmodels: unable to upsert ckeditor_assets, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to upsert ckeditor_assets")
	}
...
func (o *CkeditorAsset) DeleteG() error {
	if o == nil {
		return errors.New("kmodels: no CkeditorAsset provided for deletion")
	}
...
func (o *CkeditorAsset) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("kmodels: no CkeditorAsset provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to delete from ckeditor_assets")
	}
...
func (q ckeditorAssetQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("kmodels: no ckeditorAssetQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to delete all from ckeditor_assets")
	}
...
func (o CkeditorAssetSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("kmodels: no CkeditorAsset slice provided for delete all")
	}
...
func (o CkeditorAssetSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to delete all from ckeditorAsset slice")
	}
...
func (o *CkeditorAsset) ReloadG() error {
	if o == nil {
		return errors.New("kmodels: no CkeditorAsset provided for reload")
	}
...
func (o *CkeditorAssetSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("kmodels: empty CkeditorAssetSlice provided for reload all")
	}
...
func (o *CkeditorAssetSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to reload all in CkeditorAssetSlice")
	}
...
func CkeditorAssetExists(exec boil.Executor, id int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "kmodels: unable to check if ckeditor_assets exists")
	}
