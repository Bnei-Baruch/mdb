...
func (q containerDescriptionQuery) One() (*ContainerDescription, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "kmodels: failed to execute a one query for container_descriptions")
	}
...
func (q containerDescriptionQuery) All() (ContainerDescriptionSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "kmodels: failed to assign all query results to ContainerDescription slice")
	}
...
func (q containerDescriptionQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "kmodels: failed to count container_descriptions rows")
	}
...
func (q containerDescriptionQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "kmodels: failed to check if container_descriptions exists")
	}
...
// SetLangG of the container_description to the related item.
...
// SetLangP of the container_description to the related item.
// Sets o.R.Lang to related.
// Adds o to related.R.LangContainerDescriptions.
// Panics on error.
...
// SetLangGP of the container_description to the related item.
// Sets o.R.Lang to related.
// Adds o to related.R.LangContainerDescriptions.
...
// SetContainerG of the container_description to the related item.
...
// SetContainerP of the container_description to the related item.
// Sets o.R.Container to related.
// Adds o to related.R.ContainerDescriptions.
// Panics on error.
...
// SetContainerGP of the container_description to the related item.
// Sets o.R.Container to related.
// Adds o to related.R.ContainerDescriptions.
// Uses the global database handle and panics on error.
...
func FindContainerDescription(exec boil.Executor, id int, selectCols ...string) (*ContainerDescription, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "kmodels: unable to select from container_descriptions")
	}
...
func (o *ContainerDescription) Insert(exec boil.Executor, whitelist ...string) error {
	...
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to insert into container_descriptions")
	}
...
func (o *ContainerDescription) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("kmodels: unable to update container_descriptions, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to update container_descriptions row")
	}
...
func (q containerDescriptionQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to update all for container_descriptions")
	}
...
func (o ContainerDescriptionSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to update all in containerDescription slice")
	}
...
func (o *ContainerDescription) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("kmodels: unable to upsert container_descriptions, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to upsert container_descriptions")
	}
...
func (o *ContainerDescription) DeleteG() error {
	if o == nil {
		return errors.New("kmodels: no ContainerDescription provided for deletion")
	}
...
func (o *ContainerDescription) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("kmodels: no ContainerDescription provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to delete from container_descriptions")
	}
...
func (q containerDescriptionQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("kmodels: no containerDescriptionQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to delete all from container_descriptions")
	}
...
func (o ContainerDescriptionSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("kmodels: no ContainerDescription slice provided for delete all")
	}
...
func (o ContainerDescriptionSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to delete all from containerDescription slice")
	}
...
func (o *ContainerDescription) ReloadG() error {
	if o == nil {
		return errors.New("kmodels: no ContainerDescription provided for reload")
	}
...
func (o *ContainerDescriptionSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("kmodels: empty ContainerDescriptionSlice provided for reload all")
	}
...
func (o *ContainerDescriptionSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to reload all in ContainerDescriptionSlice")
	}
...
func ContainerDescriptionExists(exec boil.Executor, id int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "kmodels: unable to check if container_descriptions exists")
	}
