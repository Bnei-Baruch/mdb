...
func (o ContainerDescriptionPatternSlice) DeleteAll(exec boil.Executor) error {
	...
	sql := "DELETE FROM \"container_description_patterns\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 1, containerDescriptionPatternPrimaryKeyColumns, len(o))
...
func (o *ContainerDescriptionPatternSlice) ReloadAll(exec boil.Executor) error {
	...
	sql := "SELECT \"container_description_patterns\".* FROM \"container_description_patterns\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 1, containerDescriptionPatternPrimaryKeyColumns, len(*o))
