...
func (q commentQuery) One() (*Comment, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "kmodels: failed to execute a one query for comments")
	}
...
func (q commentQuery) All() (CommentSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "kmodels: failed to assign all query results to Comment slice")
	}
...
func (q commentQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "kmodels: failed to count comments rows")
	}
...
func (q commentQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "kmodels: failed to check if comments exists")
	}
...
func FindComment(exec boil.Executor, id int, selectCols ...string) (*Comment, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "kmodels: unable to select from comments")
	}
...
func (o *Comment) Insert(exec boil.Executor, whitelist ...string) error {
	...
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to insert into comments")
	}
...
func (o *Comment) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("kmodels: unable to update comments, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to update comments row")
	}
...
func (q commentQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to update all for comments")
	}
...
func (o CommentSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to update all in comment slice")
	}
...
func (o *Comment) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("kmodels: unable to upsert comments, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to upsert comments")
	}
...
func (o *Comment) DeleteG() error {
	if o == nil {
		return errors.New("kmodels: no Comment provided for deletion")
	}
...
func (o *Comment) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("kmodels: no Comment provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to delete from comments")
	}
...
func (q commentQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("kmodels: no commentQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to delete all from comments")
	}
...
func (o CommentSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("kmodels: no Comment slice provided for delete all")
	}
...
func (o CommentSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to delete all from comment slice")
	}
...
func (o *Comment) ReloadG() error {
	if o == nil {
		return errors.New("kmodels: no Comment provided for reload")
	}
...
func (o *CommentSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("kmodels: empty CommentSlice provided for reload all")
	}
...
func (o *CommentSlice) ReloadAll(exec boil.Executor) error {
	...
	err := q.Bind(&comments)
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to reload all in CommentSlice")
	}
...
func CommentExists(exec boil.Executor, id int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "kmodels: unable to check if comments exists")
	}
