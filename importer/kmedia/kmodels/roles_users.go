...
func (q rolesUserQuery) One() (*RolesUser, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "kmodels: failed to execute a one query for roles_users")
	}
...
func (q rolesUserQuery) All() (RolesUserSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "kmodels: failed to assign all query results to RolesUser slice")
	}
...
func (q rolesUserQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "kmodels: failed to count roles_users rows")
	}
...
func (q rolesUserQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "kmodels: failed to check if roles_users exists")
	}
...
// SetUserG of the roles_user to the related item.
...
// SetUserP of the roles_user to the related item.
// Sets o.R.User to related.
// Adds o to related.R.RolesUsers.
// Panics on error.
...
// SetUserGP of the roles_user to the related item.
// Sets o.R.User to related.
// Adds o to related.R.RolesUsers.
...
func FindRolesUser(exec boil.Executor, roleID int, userID int, selectCols ...string) (*RolesUser, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "kmodels: unable to select from roles_users")
	}
...
func (o *RolesUser) Insert(exec boil.Executor, whitelist ...string) error {
	...
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to insert into roles_users")
	}
...
func (o *RolesUser) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("kmodels: unable to update roles_users, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to update roles_users row")
	}
...
func (q rolesUserQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to update all for roles_users")
	}
...
func (o RolesUserSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to update all in rolesUser slice")
	}
...
func (o *RolesUser) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("kmodels: unable to upsert roles_users, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to upsert roles_users")
	}
...
func (o *RolesUser) DeleteG() error {
	if o == nil {
		return errors.New("kmodels: no RolesUser provided for deletion")
	}
...
func (o *RolesUser) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("kmodels: no RolesUser provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to delete from roles_users")
	}
...
func (q rolesUserQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("kmodels: no rolesUserQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to delete all from roles_users")
	}
...
func (o RolesUserSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("kmodels: no RolesUser slice provided for delete all")
	}
...
func (o RolesUserSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to delete all from rolesUser slice")
	}
...
func (o *RolesUser) ReloadG() error {
	if o == nil {
		return errors.New("kmodels: no RolesUser provided for reload")
	}
...
func (o *RolesUserSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("kmodels: empty RolesUserSlice provided for reload all")
	}
...
func (o *RolesUserSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to reload all in RolesUserSlice")
	}
...
func RolesUserExists(exec boil.Executor, roleID int, userID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "kmodels: unable to check if roles_users exists")
	}
