...
func (o *Server) ServernameFileAssets(exec boil.Executor, mods ...qm.QueryMod) fileAssetQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"a\".\"servername_id\"=?", o.Servername),
	)
...
func (o *Server) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("kmodels: no Server provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to delete from servers")
	}
...
func (q serverQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("kmodels: no serverQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to delete all from servers")
	}
...
func (o ServerSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("kmodels: no Server slice provided for delete all")
	}
...
func (o ServerSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to delete all from server slice")
	}
...
func (o *Server) ReloadG() error {
	if o == nil {
		return errors.New("kmodels: no Server provided for reload")
	}
...
func (o *ServerSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("kmodels: empty ServerSlice provided for reload all")
	}
...
func (o *ServerSlice) ReloadAll(exec boil.Executor) error {
	...
	err := q.Bind(&servers)
	if err != nil {
		return errors.Wrap(err, "kmodels: unable to reload all in ServerSlice")
	}
...
func ServerExists(exec boil.Executor, id int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "kmodels: unable to check if servers exists")
	}
