...
func (q contentRoleQuery) One() (*ContentRole, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: failed to execute a one query for content_roles")
	}
...
func (q contentRoleQuery) All() (ContentRoleSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "models: failed to assign all query results to ContentRole slice")
	}
...
func (q contentRoleQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to count content_roles rows")
	}
...
func (q contentRoleQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "models: failed to check if content_roles exists")
	}
...
// SetDescriptionG of the content_role to the related item.
// Sets o.R.Description to related.
// Adds o to related.R.DescriptionContentRoles.
// Uses the global database handle.
func (o *ContentRole) SetDescriptionG(insert bool, related *StringTranslation) error {
	return o.SetDescription(boil.GetDB(), insert, related)
}

// SetDescriptionP of the content_role to the related item.
// Sets o.R.Description to related.
// Adds o to related.R.DescriptionContentRoles.
// Panics on error.
func (o *ContentRole) SetDescriptionP(exec boil.Executor, insert bool, related *StringTranslation) {
	if err := o.SetDescription(exec, insert, related); err != nil {
		panic(boil.WrapErr(err))
	}
}

// SetDescriptionGP of the content_role to the related item.
// Sets o.R.Description to related.
// Adds o to related.R.DescriptionContentRoles.
// Uses the global database handle and panics on error.
func (o *ContentRole) SetDescriptionGP(insert bool, related *StringTranslation) {
...
// Uses the global database handle.
func (o *ContentRole) RemoveDescriptionG(related *StringTranslation) error {
...
// Removes o from all passed in related items' relationships struct (Optional).
// Panics on error.
func (o *ContentRole) RemoveDescriptionP(exec boil.Executor, related *StringTranslation) {
...
// Removes o from all passed in related items' relationships struct (Optional).
// Uses the global database handle and panics on error.
func (o *ContentRole) RemoveDescriptionGP(related *StringTranslation) {
...
// SetNameG of the content_role to the related item.
// Sets o.R.Name to related.
// Adds o to related.R.NameContentRoles.
// Uses the global database handle.
func (o *ContentRole) SetNameG(insert bool, related *StringTranslation) error {
	return o.SetName(boil.GetDB(), insert, related)
}

// SetNameP of the content_role to the related item.
// Sets o.R.Name to related.
// Adds o to related.R.NameContentRoles.
// Panics on error.
func (o *ContentRole) SetNameP(exec boil.Executor, insert bool, related *StringTranslation) {
	if err := o.SetName(exec, insert, related); err != nil {
		panic(boil.WrapErr(err))
	}
}

// SetNameGP of the content_role to the related item.
// Sets o.R.Name to related.
// Adds o to related.R.NameContentRoles.
// Uses the global database handle and panics on error.
func (o *ContentRole) SetNameGP(insert bool, related *StringTranslation) {
...
// Uses the global database handle.
func (o *ContentRole) AddRoleContentUnitsPersonsG(insert bool, related ...*ContentUnitsPerson) error {
...
// Sets related.R.Role appropriately.
// Panics on error.
func (o *ContentRole) AddRoleContentUnitsPersonsP(exec boil.Executor, insert bool, related ...*ContentUnitsPerson) {
...
// Sets related.R.Role appropriately.
// Uses the global database handle and panics on error.
func (o *ContentRole) AddRoleContentUnitsPersonsGP(insert bool, related ...*ContentUnitsPerson) {
...
func FindContentRole(exec boil.Executor, id int64, selectCols ...string) (*ContentRole, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: unable to select from content_roles")
	}
...
func (o *ContentRole) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no content_roles provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to insert into content_roles")
	}
...
func (o *ContentRole) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("models: unable to update content_roles, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update content_roles row")
	}
...
func (q contentRoleQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to update all for content_roles")
	}
...
func (o ContentRoleSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update all in contentRole slice")
	}
...
func (o *ContentRole) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no content_roles provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("models: unable to upsert content_roles, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert content_roles")
	}
...
func (o *ContentRole) DeleteG() error {
	if o == nil {
		return errors.New("models: no ContentRole provided for deletion")
	}
...
func (o *ContentRole) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("models: no ContentRole provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete from content_roles")
	}
...
func (q contentRoleQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("models: no contentRoleQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from content_roles")
	}
...
func (o ContentRoleSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("models: no ContentRole slice provided for delete all")
	}
...
func (o ContentRoleSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from contentRole slice")
	}
...
func (o *ContentRole) ReloadG() error {
	if o == nil {
		return errors.New("models: no ContentRole provided for reload")
	}
...
func (o *ContentRoleSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("models: empty ContentRoleSlice provided for reload all")
	}
...
func (o *ContentRoleSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to reload all in ContentRoleSlice")
	}
...
func ContentRoleExists(exec boil.Executor, id int64) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models: unable to check if content_roles exists")
	}
