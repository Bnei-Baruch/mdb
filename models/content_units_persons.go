...
// Uses the global database handle.
func (o *ContentUnitsPerson) SetRoleG(insert bool, related *ContentRole) error {
...
// Adds o to related.R.RoleContentUnitsPersons.
// Panics on error.
func (o *ContentUnitsPerson) SetRoleP(exec boil.Executor, insert bool, related *ContentRole) {
...
// Adds o to related.R.RoleContentUnitsPersons.
// Uses the global database handle and panics on error.
func (o *ContentUnitsPerson) SetRoleGP(insert bool, related *ContentRole) {
...
func (o *ContentUnitsPerson) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("models: unable to update content_units_persons, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update content_units_persons row")
	}
...
func (q contentUnitsPersonQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to update all for content_units_persons")
	}
...
func (o ContentUnitsPersonSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update all in contentUnitsPerson slice")
	}
...
func (o *ContentUnitsPerson) DeleteG() error {
	if o == nil {
		return errors.New("models: no ContentUnitsPerson provided for deletion")
	}
...
func (o *ContentUnitsPerson) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("models: no ContentUnitsPerson provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete from content_units_persons")
	}
...
func (q contentUnitsPersonQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("models: no contentUnitsPersonQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from content_units_persons")
	}
...
func (o ContentUnitsPersonSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("models: no ContentUnitsPerson slice provided for delete all")
	}
...
func (o ContentUnitsPersonSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from contentUnitsPerson slice")
	}
...
func (o *ContentUnitsPerson) ReloadG() error {
	if o == nil {
		return errors.New("models: no ContentUnitsPerson provided for reload")
	}
...
func (o *ContentUnitsPersonSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("models: empty ContentUnitsPersonSlice provided for reload all")
	}
