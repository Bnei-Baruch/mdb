...
func testTwitterTweetsDelete(t *testing.T) {
	...
	count, err := TwitterTweets().Count(tx)
	if err != nil {
		t.Error(err)
	}
...
func testTwitterTweetsQueryDeleteAll(t *testing.T) {
	...
	if rowsAff, err := TwitterTweets().DeleteAll(tx); err != nil {
		t.Error(err)
	} else if rowsAff != 1 {
		t.Error("should only have deleted one row, but affected:", rowsAff)
	}
...
func testTwitterTweetsExists(t *testing.T) {
	...
	e, err := TwitterTweetExists(tx, o.ID)
	if err != nil {
...
func testTwitterTweetsFind(t *testing.T) {
	...
	twitterTweetFound, err := FindTwitterTweet(tx, o.ID)
	if err != nil {
		t.Error(err)
	}
...
func testTwitterTweetsBind(t *testing.T) {
	...
	if err = TwitterTweets().Bind(nil, tx, o); err != nil {
		t.Error(err)
	}
}
...
func testTwitterTweetsOne(t *testing.T) {
	...
	if x, err := TwitterTweets().One(tx); err != nil {
		t.Error(err)
	} else if x == nil {
...
func testTwitterTweetsAll(t *testing.T) {
	...
	tx := MustTx(boil.Begin())
	defer func() { _ = tx.Rollback() }()
	if err = twitterTweetOne.Insert(tx, boil.Infer()); err != nil {
		t.Error(err)
	}
	if err = twitterTweetTwo.Insert(tx, boil.Infer()); err != nil {
		t.Error(err)
	}

	slice, err := TwitterTweets().All(tx)
	if err != nil {
		t.Error(err)
	}
...
func testTwitterTweetsInsertWhitelist(t *testing.T) {
	...
	tx := MustTx(boil.Begin())
	defer func() { _ = tx.Rollback() }()
	if err = o.Insert(tx, boil.Whitelist(twitterTweetColumnsWithoutDefault...)); err != nil {
		t.Error(err)
	}
...
func testTwitterTweetToOneTwitterUserUsingUser(t *testing.T) {
	...
	if err = local.L.LoadUser(tx, false, (*[]*TwitterTweet)(&slice), nil); err != nil {
		t.Fatal(err)
	}
	if local.R.User == nil {
