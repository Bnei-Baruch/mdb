...
func (o *BlogPost) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("models: unable to update blog_posts, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update blog_posts row")
	}
...
func (q blogPostQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to update all for blog_posts")
	}
...
func (o BlogPostSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update all in blogPost slice")
	}
...
func (o *BlogPost) DeleteG() error {
	if o == nil {
		return errors.New("models: no BlogPost provided for deletion")
	}
...
func (o *BlogPost) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("models: no BlogPost provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete from blog_posts")
	}
...
func (q blogPostQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("models: no blogPostQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from blog_posts")
	}
...
func (o BlogPostSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("models: no BlogPost slice provided for delete all")
	}
...
func (o BlogPostSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from blogPost slice")
	}
