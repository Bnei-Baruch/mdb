...
func testOperationsInsertWhitelist(t *testing.T) {
	...
	tx := MustTx(boil.Begin())
	defer tx.Rollback()
	if err = operation.Insert(tx, operationColumnsWithoutDefault...); err != nil {
		t.Error(err)
	}
...
func testOperationToManyFiles(t *testing.T) {
	...
	if err = a.L.LoadFiles(tx, false, (*[]*Operation)(&slice)); err != nil {
		t.Fatal(err)
	}
...
func testOperationToOneOperationTypeUsingType(t *testing.T) {
	...
	if err = local.L.LoadType(tx, false, (*[]*Operation)(&slice)); err != nil {
		t.Fatal(err)
	}
	if local.R.Type == nil {
...
func testOperationToOneUserUsingUser(t *testing.T) {
	...
	slice := OperationSlice{&local}
	if err = local.L.LoadUser(tx, false, (*[]*Operation)(&slice)); err != nil {
		t.Fatal(err)
	}
	if local.R.User == nil {
		t.Error("struct should have been eager loaded")
