...
func (q stringTranslationQuery) One() (*StringTranslation, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: failed to execute a one query for string_translations")
	}
...
func (q stringTranslationQuery) All() (StringTranslationSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "models: failed to assign all query results to StringTranslation slice")
	}
...
func (q stringTranslationQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to count string_translations rows")
	}
...
func (q stringTranslationQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "models: failed to check if string_translations exists")
	}
...
// AddDescriptionPersonsG adds the given related objects to the existing relationships
...
func (o *StringTranslation) AddDescriptionPersonsG(insert bool, related ...*Person) error {
	return o.AddDescriptionPersons(boil.GetDB(), insert, related...)
}

// AddDescriptionPersonsP adds the given related objects to the existing relationships
// of the string_translation, optionally inserting them as new records.
// Appends related to o.R.DescriptionPersons.
// Sets related.R.Description appropriately.
// Panics on error.
func (o *StringTranslation) AddDescriptionPersonsP(exec boil.Executor, insert bool, related ...*Person) {
	if err := o.AddDescriptionPersons(exec, insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}

// AddDescriptionPersonsGP adds the given related objects to the existing relationships
// of the string_translation, optionally inserting them as new records.
// Appends related to o.R.DescriptionPersons.
// Sets related.R.Description appropriately.
// Uses the global database handle and panics on error.
func (o *StringTranslation) AddDescriptionPersonsGP(insert bool, related ...*Person) {
	if err := o.AddDescriptionPersons(boil.GetDB(), insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}
...
// SetDescriptionPersonsG removes all previously related items of the
...
// Uses the global database handle.
func (o *StringTranslation) SetDescriptionPersonsG(insert bool, related ...*Person) error {
	return o.SetDescriptionPersons(boil.GetDB(), insert, related...)
}

// SetDescriptionPersonsP removes all previously related items of the
// string_translation replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.Description's DescriptionPersons accordingly.
// Replaces o.R.DescriptionPersons with related.
// Sets related.R.Description's DescriptionPersons accordingly.
// Panics on error.
func (o *StringTranslation) SetDescriptionPersonsP(exec boil.Executor, insert bool, related ...*Person) {
	if err := o.SetDescriptionPersons(exec, insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}

// SetDescriptionPersonsGP removes all previously related items of the
// string_translation replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.Description's DescriptionPersons accordingly.
// Replaces o.R.DescriptionPersons with related.
// Sets related.R.Description's DescriptionPersons accordingly.
// Uses the global database handle and panics on error.
func (o *StringTranslation) SetDescriptionPersonsGP(insert bool, related ...*Person) {
	if err := o.SetDescriptionPersons(boil.GetDB(), insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}
...
// RemoveDescriptionPersonsG relationships from objects passed in.
...
// Uses the global database handle.
func (o *StringTranslation) RemoveDescriptionPersonsG(related ...*Person) error {
	return o.RemoveDescriptionPersons(boil.GetDB(), related...)
}

// RemoveDescriptionPersonsP relationships from objects passed in.
// Removes related items from R.DescriptionPersons (uses pointer comparison, removal does not keep order)
// Sets related.R.Description.
// Panics on error.
func (o *StringTranslation) RemoveDescriptionPersonsP(exec boil.Executor, related ...*Person) {
	if err := o.RemoveDescriptionPersons(exec, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}

// RemoveDescriptionPersonsGP relationships from objects passed in.
// Removes related items from R.DescriptionPersons (uses pointer comparison, removal does not keep order)
// Sets related.R.Description.
// Uses the global database handle and panics on error.
func (o *StringTranslation) RemoveDescriptionPersonsGP(related ...*Person) {
	if err := o.RemoveDescriptionPersons(boil.GetDB(), related...); err != nil {
		panic(boil.WrapErr(err))
	}
}
...
// AddNamePersonsG adds the given related objects to the existing relationships
// of the string_translation, optionally inserting them as new records.
// Appends related to o.R.NamePersons.
// Sets related.R.Name appropriately.
// Uses the global database handle.
func (o *StringTranslation) AddNamePersonsG(insert bool, related ...*Person) error {
	return o.AddNamePersons(boil.GetDB(), insert, related...)
}

// AddNamePersonsP adds the given related objects to the existing relationships
// of the string_translation, optionally inserting them as new records.
// Appends related to o.R.NamePersons.
// Sets related.R.Name appropriately.
// Panics on error.
func (o *StringTranslation) AddNamePersonsP(exec boil.Executor, insert bool, related ...*Person) {
	if err := o.AddNamePersons(exec, insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}

// AddNamePersonsGP adds the given related objects to the existing relationships
// of the string_translation, optionally inserting them as new records.
// Appends related to o.R.NamePersons.
// Sets related.R.Name appropriately.
// Uses the global database handle and panics on error.
func (o *StringTranslation) AddNamePersonsGP(insert bool, related ...*Person) {
	if err := o.AddNamePersons(boil.GetDB(), insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}
...
// AddLabelTagsG adds the given related objects to the existing relationships
// of the string_translation, optionally inserting them as new records.
// Appends related to o.R.LabelTags.
// Sets related.R.Label appropriately.
// Uses the global database handle.
func (o *StringTranslation) AddLabelTagsG(insert bool, related ...*Tag) error {
	return o.AddLabelTags(boil.GetDB(), insert, related...)
}

// AddLabelTagsP adds the given related objects to the existing relationships
// of the string_translation, optionally inserting them as new records.
// Appends related to o.R.LabelTags.
// Sets related.R.Label appropriately.
// Panics on error.
func (o *StringTranslation) AddLabelTagsP(exec boil.Executor, insert bool, related ...*Tag) {
	if err := o.AddLabelTags(exec, insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}

// AddLabelTagsGP adds the given related objects to the existing relationships
// of the string_translation, optionally inserting them as new records.
// Appends related to o.R.LabelTags.
// Sets related.R.Label appropriately.
// Uses the global database handle and panics on error.
func (o *StringTranslation) AddLabelTagsGP(insert bool, related ...*Tag) {
	if err := o.AddLabelTags(boil.GetDB(), insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}
...
// AddDescriptionContentUnitsG adds the given related objects to the existing relationships
// of the string_translation, optionally inserting them as new records.
// Appends related to o.R.DescriptionContentUnits.
// Sets related.R.Description appropriately.
// Uses the global database handle.
func (o *StringTranslation) AddDescriptionContentUnitsG(insert bool, related ...*ContentUnit) error {
	return o.AddDescriptionContentUnits(boil.GetDB(), insert, related...)
}

// AddDescriptionContentUnitsP adds the given related objects to the existing relationships
// of the string_translation, optionally inserting them as new records.
// Appends related to o.R.DescriptionContentUnits.
// Sets related.R.Description appropriately.
// Panics on error.
func (o *StringTranslation) AddDescriptionContentUnitsP(exec boil.Executor, insert bool, related ...*ContentUnit) {
	if err := o.AddDescriptionContentUnits(exec, insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}

// AddDescriptionContentUnitsGP adds the given related objects to the existing relationships
// of the string_translation, optionally inserting them as new records.
// Appends related to o.R.DescriptionContentUnits.
// Sets related.R.Description appropriately.
// Uses the global database handle and panics on error.
func (o *StringTranslation) AddDescriptionContentUnitsGP(insert bool, related ...*ContentUnit) {
	if err := o.AddDescriptionContentUnits(boil.GetDB(), insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}
...
// SetDescriptionContentUnitsG removes all previously related items of the
// string_translation replacing them completely with the passed
// in related items, optionally inserting them as new records.
...
// Uses the global database handle.
func (o *StringTranslation) SetDescriptionContentUnitsG(insert bool, related ...*ContentUnit) error {
	return o.SetDescriptionContentUnits(boil.GetDB(), insert, related...)
}

// SetDescriptionContentUnitsP removes all previously related items of the
// string_translation replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.Description's DescriptionContentUnits accordingly.
// Replaces o.R.DescriptionContentUnits with related.
// Sets related.R.Description's DescriptionContentUnits accordingly.
// Panics on error.
func (o *StringTranslation) SetDescriptionContentUnitsP(exec boil.Executor, insert bool, related ...*ContentUnit) {
	if err := o.SetDescriptionContentUnits(exec, insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}

// SetDescriptionContentUnitsGP removes all previously related items of the
// string_translation replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.Description's DescriptionContentUnits accordingly.
// Replaces o.R.DescriptionContentUnits with related.
// Sets related.R.Description's DescriptionContentUnits accordingly.
// Uses the global database handle and panics on error.
func (o *StringTranslation) SetDescriptionContentUnitsGP(insert bool, related ...*ContentUnit) {
	if err := o.SetDescriptionContentUnits(boil.GetDB(), insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}
...
// RemoveDescriptionContentUnitsG relationships from objects passed in.
// Removes related items from R.DescriptionContentUnits (uses pointer comparison, removal does not keep order)
// Sets related.R.Description.
// Uses the global database handle.
func (o *StringTranslation) RemoveDescriptionContentUnitsG(related ...*ContentUnit) error {
	return o.RemoveDescriptionContentUnits(boil.GetDB(), related...)
}

// RemoveDescriptionContentUnitsP relationships from objects passed in.
// Removes related items from R.DescriptionContentUnits (uses pointer comparison, removal does not keep order)
// Sets related.R.Description.
// Panics on error.
func (o *StringTranslation) RemoveDescriptionContentUnitsP(exec boil.Executor, related ...*ContentUnit) {
	if err := o.RemoveDescriptionContentUnits(exec, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}

// RemoveDescriptionContentUnitsGP relationships from objects passed in.
// Removes related items from R.DescriptionContentUnits (uses pointer comparison, removal does not keep order)
// Sets related.R.Description.
// Uses the global database handle and panics on error.
func (o *StringTranslation) RemoveDescriptionContentUnitsGP(related ...*ContentUnit) {
	if err := o.RemoveDescriptionContentUnits(boil.GetDB(), related...); err != nil {
		panic(boil.WrapErr(err))
	}
}
...
// AddNameContentUnitsG adds the given related objects to the existing relationships
// of the string_translation, optionally inserting them as new records.
// Appends related to o.R.NameContentUnits.
// Sets related.R.Name appropriately.
// Uses the global database handle.
func (o *StringTranslation) AddNameContentUnitsG(insert bool, related ...*ContentUnit) error {
	return o.AddNameContentUnits(boil.GetDB(), insert, related...)
}

// AddNameContentUnitsP adds the given related objects to the existing relationships
// of the string_translation, optionally inserting them as new records.
// Appends related to o.R.NameContentUnits.
// Sets related.R.Name appropriately.
// Panics on error.
func (o *StringTranslation) AddNameContentUnitsP(exec boil.Executor, insert bool, related ...*ContentUnit) {
	if err := o.AddNameContentUnits(exec, insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}

// AddNameContentUnitsGP adds the given related objects to the existing relationships
// of the string_translation, optionally inserting them as new records.
// Appends related to o.R.NameContentUnits.
// Sets related.R.Name appropriately.
// Uses the global database handle and panics on error.
func (o *StringTranslation) AddNameContentUnitsGP(insert bool, related ...*ContentUnit) {
	if err := o.AddNameContentUnits(boil.GetDB(), insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}
...
// AddDescriptionCollectionsG adds the given related objects to the existing relationships
// of the string_translation, optionally inserting them as new records.
// Appends related to o.R.DescriptionCollections.
// Sets related.R.Description appropriately.
// Uses the global database handle.
func (o *StringTranslation) AddDescriptionCollectionsG(insert bool, related ...*Collection) error {
	return o.AddDescriptionCollections(boil.GetDB(), insert, related...)
}

// AddDescriptionCollectionsP adds the given related objects to the existing relationships
// of the string_translation, optionally inserting them as new records.
// Appends related to o.R.DescriptionCollections.
// Sets related.R.Description appropriately.
// Panics on error.
func (o *StringTranslation) AddDescriptionCollectionsP(exec boil.Executor, insert bool, related ...*Collection) {
	if err := o.AddDescriptionCollections(exec, insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}

// AddDescriptionCollectionsGP adds the given related objects to the existing relationships
// of the string_translation, optionally inserting them as new records.
// Appends related to o.R.DescriptionCollections.
// Sets related.R.Description appropriately.
// Uses the global database handle and panics on error.
func (o *StringTranslation) AddDescriptionCollectionsGP(insert bool, related ...*Collection) {
	if err := o.AddDescriptionCollections(boil.GetDB(), insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}
...
// SetDescriptionCollectionsG removes all previously related items of the
// string_translation replacing them completely with the passed
// in related items, optionally inserting them as new records.
...
// Uses the global database handle.
func (o *StringTranslation) SetDescriptionCollectionsG(insert bool, related ...*Collection) error {
	return o.SetDescriptionCollections(boil.GetDB(), insert, related...)
}

// SetDescriptionCollectionsP removes all previously related items of the
// string_translation replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.Description's DescriptionCollections accordingly.
// Replaces o.R.DescriptionCollections with related.
// Sets related.R.Description's DescriptionCollections accordingly.
// Panics on error.
func (o *StringTranslation) SetDescriptionCollectionsP(exec boil.Executor, insert bool, related ...*Collection) {
	if err := o.SetDescriptionCollections(exec, insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}

// SetDescriptionCollectionsGP removes all previously related items of the
// string_translation replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.Description's DescriptionCollections accordingly.
// Replaces o.R.DescriptionCollections with related.
// Sets related.R.Description's DescriptionCollections accordingly.
// Uses the global database handle and panics on error.
func (o *StringTranslation) SetDescriptionCollectionsGP(insert bool, related ...*Collection) {
	if err := o.SetDescriptionCollections(boil.GetDB(), insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}
...
// RemoveDescriptionCollectionsG relationships from objects passed in.
// Removes related items from R.DescriptionCollections (uses pointer comparison, removal does not keep order)
// Sets related.R.Description.
// Uses the global database handle.
func (o *StringTranslation) RemoveDescriptionCollectionsG(related ...*Collection) error {
	return o.RemoveDescriptionCollections(boil.GetDB(), related...)
}

// RemoveDescriptionCollectionsP relationships from objects passed in.
// Removes related items from R.DescriptionCollections (uses pointer comparison, removal does not keep order)
// Sets related.R.Description.
// Panics on error.
func (o *StringTranslation) RemoveDescriptionCollectionsP(exec boil.Executor, related ...*Collection) {
	if err := o.RemoveDescriptionCollections(exec, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}

// RemoveDescriptionCollectionsGP relationships from objects passed in.
// Removes related items from R.DescriptionCollections (uses pointer comparison, removal does not keep order)
// Sets related.R.Description.
// Uses the global database handle and panics on error.
func (o *StringTranslation) RemoveDescriptionCollectionsGP(related ...*Collection) {
	if err := o.RemoveDescriptionCollections(boil.GetDB(), related...); err != nil {
		panic(boil.WrapErr(err))
	}
}
...
// AddNameCollectionsG adds the given related objects to the existing relationships
// of the string_translation, optionally inserting them as new records.
// Appends related to o.R.NameCollections.
// Sets related.R.Name appropriately.
// Uses the global database handle.
func (o *StringTranslation) AddNameCollectionsG(insert bool, related ...*Collection) error {
	return o.AddNameCollections(boil.GetDB(), insert, related...)
}

// AddNameCollectionsP adds the given related objects to the existing relationships
// of the string_translation, optionally inserting them as new records.
// Appends related to o.R.NameCollections.
// Sets related.R.Name appropriately.
// Panics on error.
func (o *StringTranslation) AddNameCollectionsP(exec boil.Executor, insert bool, related ...*Collection) {
	if err := o.AddNameCollections(exec, insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}

// AddNameCollectionsGP adds the given related objects to the existing relationships
// of the string_translation, optionally inserting them as new records.
// Appends related to o.R.NameCollections.
// Sets related.R.Name appropriately.
// Uses the global database handle and panics on error.
func (o *StringTranslation) AddNameCollectionsGP(insert bool, related ...*Collection) {
	if err := o.AddNameCollections(boil.GetDB(), insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}
...
// AddDescriptionContentRolesG adds the given related objects to the existing relationships
// of the string_translation, optionally inserting them as new records.
// Appends related to o.R.DescriptionContentRoles.
// Sets related.R.Description appropriately.
// Uses the global database handle.
func (o *StringTranslation) AddDescriptionContentRolesG(insert bool, related ...*ContentRole) error {
	return o.AddDescriptionContentRoles(boil.GetDB(), insert, related...)
}

// AddDescriptionContentRolesP adds the given related objects to the existing relationships
// of the string_translation, optionally inserting them as new records.
// Appends related to o.R.DescriptionContentRoles.
// Sets related.R.Description appropriately.
// Panics on error.
func (o *StringTranslation) AddDescriptionContentRolesP(exec boil.Executor, insert bool, related ...*ContentRole) {
	if err := o.AddDescriptionContentRoles(exec, insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}

// AddDescriptionContentRolesGP adds the given related objects to the existing relationships
// of the string_translation, optionally inserting them as new records.
// Appends related to o.R.DescriptionContentRoles.
// Sets related.R.Description appropriately.
// Uses the global database handle and panics on error.
func (o *StringTranslation) AddDescriptionContentRolesGP(insert bool, related ...*ContentRole) {
	if err := o.AddDescriptionContentRoles(boil.GetDB(), insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}
...
// SetDescriptionContentRolesG removes all previously related items of the
// string_translation replacing them completely with the passed
// in related items, optionally inserting them as new records.
...
// Uses the global database handle.
func (o *StringTranslation) SetDescriptionContentRolesG(insert bool, related ...*ContentRole) error {
	return o.SetDescriptionContentRoles(boil.GetDB(), insert, related...)
}

// SetDescriptionContentRolesP removes all previously related items of the
// string_translation replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.Description's DescriptionContentRoles accordingly.
// Replaces o.R.DescriptionContentRoles with related.
// Sets related.R.Description's DescriptionContentRoles accordingly.
// Panics on error.
func (o *StringTranslation) SetDescriptionContentRolesP(exec boil.Executor, insert bool, related ...*ContentRole) {
	if err := o.SetDescriptionContentRoles(exec, insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}

// SetDescriptionContentRolesGP removes all previously related items of the
// string_translation replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.Description's DescriptionContentRoles accordingly.
// Replaces o.R.DescriptionContentRoles with related.
// Sets related.R.Description's DescriptionContentRoles accordingly.
// Uses the global database handle and panics on error.
func (o *StringTranslation) SetDescriptionContentRolesGP(insert bool, related ...*ContentRole) {
	if err := o.SetDescriptionContentRoles(boil.GetDB(), insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}
...
// RemoveDescriptionContentRolesG relationships from objects passed in.
// Removes related items from R.DescriptionContentRoles (uses pointer comparison, removal does not keep order)
// Sets related.R.Description.
// Uses the global database handle.
func (o *StringTranslation) RemoveDescriptionContentRolesG(related ...*ContentRole) error {
	return o.RemoveDescriptionContentRoles(boil.GetDB(), related...)
}

// RemoveDescriptionContentRolesP relationships from objects passed in.
// Removes related items from R.DescriptionContentRoles (uses pointer comparison, removal does not keep order)
// Sets related.R.Description.
// Panics on error.
func (o *StringTranslation) RemoveDescriptionContentRolesP(exec boil.Executor, related ...*ContentRole) {
	if err := o.RemoveDescriptionContentRoles(exec, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}

// RemoveDescriptionContentRolesGP relationships from objects passed in.
// Removes related items from R.DescriptionContentRoles (uses pointer comparison, removal does not keep order)
// Sets related.R.Description.
// Uses the global database handle and panics on error.
func (o *StringTranslation) RemoveDescriptionContentRolesGP(related ...*ContentRole) {
	if err := o.RemoveDescriptionContentRoles(boil.GetDB(), related...); err != nil {
		panic(boil.WrapErr(err))
	}
}
...
// AddNameContentRolesG adds the given related objects to the existing relationships
// of the string_translation, optionally inserting them as new records.
// Appends related to o.R.NameContentRoles.
// Sets related.R.Name appropriately.
// Uses the global database handle.
func (o *StringTranslation) AddNameContentRolesG(insert bool, related ...*ContentRole) error {
	return o.AddNameContentRoles(boil.GetDB(), insert, related...)
}

// AddNameContentRolesP adds the given related objects to the existing relationships
// of the string_translation, optionally inserting them as new records.
// Appends related to o.R.NameContentRoles.
// Sets related.R.Name appropriately.
// Panics on error.
func (o *StringTranslation) AddNameContentRolesP(exec boil.Executor, insert bool, related ...*ContentRole) {
	if err := o.AddNameContentRoles(exec, insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}

// AddNameContentRolesGP adds the given related objects to the existing relationships
// of the string_translation, optionally inserting them as new records.
// Appends related to o.R.NameContentRoles.
// Sets related.R.Name appropriately.
// Uses the global database handle and panics on error.
func (o *StringTranslation) AddNameContentRolesGP(insert bool, related ...*ContentRole) {
	if err := o.AddNameContentRoles(boil.GetDB(), insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}
...
func FindStringTranslation(exec boil.Executor, id int64, language string, selectCols ...string) (*StringTranslation, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: unable to select from string_translations")
	}
...
func (o *StringTranslation) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no string_translations provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to insert into string_translations")
	}
...
func (o *StringTranslation) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("models: unable to update string_translations, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update string_translations row")
	}
...
func (q stringTranslationQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to update all for string_translations")
	}
...
func (o StringTranslationSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update all in stringTranslation slice")
	}
...
func (o *StringTranslation) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no string_translations provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("models: unable to upsert string_translations, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert string_translations")
	}
...
func (o *StringTranslation) DeleteG() error {
	if o == nil {
		return errors.New("models: no StringTranslation provided for deletion")
	}
...
func (o *StringTranslation) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("models: no StringTranslation provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete from string_translations")
	}
...
func (q stringTranslationQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("models: no stringTranslationQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from string_translations")
	}
...
func (o StringTranslationSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("models: no StringTranslation slice provided for delete all")
	}
...
func (o StringTranslationSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from stringTranslation slice")
	}
...
func (o *StringTranslation) ReloadG() error {
	if o == nil {
		return errors.New("models: no StringTranslation provided for reload")
	}
...
func (o *StringTranslationSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("models: empty StringTranslationSlice provided for reload all")
	}
...
func (o *StringTranslationSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to reload all in StringTranslationSlice")
	}
...
func StringTranslationExists(exec boil.Executor, id int64, language string) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models: unable to check if string_translations exists")
	}
