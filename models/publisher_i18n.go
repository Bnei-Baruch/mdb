...
func (o *PublisherI18n) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("models: unable to update publisher_i18n, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update publisher_i18n row")
	}
...
func (q publisherI18nQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to update all for publisher_i18n")
	}
...
func (o PublisherI18nSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update all in publisherI18n slice")
	}
...
func (o *PublisherI18n) DeleteG() error {
	if o == nil {
		return errors.New("models: no PublisherI18n provided for deletion")
	}
...
func (o *PublisherI18n) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("models: no PublisherI18n provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete from publisher_i18n")
	}
...
func (q publisherI18nQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("models: no publisherI18nQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from publisher_i18n")
	}
...
func (o PublisherI18nSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("models: no PublisherI18n slice provided for delete all")
	}
...
func (o PublisherI18nSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from publisherI18n slice")
	}
...
func (o *PublisherI18n) ReloadG() error {
	if o == nil {
		return errors.New("models: no PublisherI18n provided for reload")
	}
...
func (o *PublisherI18nSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("models: empty PublisherI18nSlice provided for reload all")
	}
