...
func (o *Publisher) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("models: unable to update publishers, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update publishers row")
	}
...
func (q publisherQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to update all for publishers")
	}
...
func (o PublisherSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update all in publisher slice")
	}
...
func (o *Publisher) DeleteG() error {
	if o == nil {
		return errors.New("models: no Publisher provided for deletion")
	}
...
func (o *Publisher) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("models: no Publisher provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete from publishers")
	}
...
func (q publisherQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("models: no publisherQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from publishers")
	}
...
func (o PublisherSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("models: no Publisher slice provided for delete all")
	}
...
func (o PublisherSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from publisher slice")
	}
