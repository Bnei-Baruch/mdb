...
func TestToOneSet(t *testing.T) {
	...
	t.Run("ContentUnitDerivationToContentUnitUsingDerived", testContentUnitDerivationToOneSetOpContentUnitUsingDerived)
	t.Run("ContentUnitDerivationToContentUnitUsingSource", testContentUnitDerivationToOneSetOpContentUnitUsingSource)
	...
	t.Run("ContentUnitsPersonToContentRoleTypeUsingRole", testContentUnitsPersonToOneSetOpContentRoleTypeUsingRole)
	...
	t.Run("LabelI18nToLabelUsingLabel", testLabelI18nToOneSetOpLabelUsingLabel)
	t.Run("LabelI18nToUserUsingUser", testLabelI18nToOneSetOpUserUsingUser)
	t.Run("LabelToContentUnitUsingContentUnit", testLabelToOneSetOpContentUnitUsingContentUnit)
	...
	t.Run("PersonI18nToPersonUsingPerson", testPersonI18nToOneSetOpPersonUsingPerson)
	t.Run("PersonI18nToUserUsingUser", testPersonI18nToOneSetOpUserUsingUser)
	t.Run("PublisherI18nToPublisherUsingPublisher", testPublisherI18nToOneSetOpPublisherUsingPublisher)
	t.Run("PublisherI18nToUserUsingUser", testPublisherI18nToOneSetOpUserUsingUser)
...
func TestToOneRemove(t *testing.T) {
	...
	t.Run("LabelI18nToUserUsingUser", testLabelI18nToOneRemoveOpUserUsingUser)
	t.Run("OperationToUserUsingUser", testOperationToOneRemoveOpUserUsingUser)
	t.Run("PersonI18nToUserUsingUser", testPersonI18nToOneRemoveOpUserUsingUser)
	t.Run("PublisherI18nToUserUsingUser", testPublisherI18nToOneRemoveOpUserUsingUser)
