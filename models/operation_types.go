...
func (o *OperationType) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("models: unable to update operation_types, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update operation_types row")
	}
...
func (q operationTypeQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to update all for operation_types")
	}
...
func (o OperationTypeSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update all in operationType slice")
	}
...
func (o *OperationType) DeleteG() error {
	if o == nil {
		return errors.New("models: no OperationType provided for deletion")
	}
...
func (o *OperationType) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("models: no OperationType provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete from operation_types")
	}
...
func (q operationTypeQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("models: no operationTypeQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from operation_types")
	}
...
func (o OperationTypeSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("models: no OperationType slice provided for delete all")
	}
...
func (o OperationTypeSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from operationType slice")
	}
...
func (o *OperationType) ReloadG() error {
	if o == nil {
		return errors.New("models: no OperationType provided for reload")
	}
...
func (o *OperationTypeSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("models: empty OperationTypeSlice provided for reload all")
	}
