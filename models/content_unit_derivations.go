...
func (o *ContentUnitDerivation) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("models: unable to update content_unit_derivations, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update content_unit_derivations row")
	}
...
func (q contentUnitDerivationQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to update all for content_unit_derivations")
	}
...
func (o ContentUnitDerivationSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update all in contentUnitDerivation slice")
	}
...
func (o *ContentUnitDerivation) DeleteG() error {
	if o == nil {
		return errors.New("models: no ContentUnitDerivation provided for deletion")
	}
...
func (o *ContentUnitDerivation) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("models: no ContentUnitDerivation provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete from content_unit_derivations")
	}
...
func (q contentUnitDerivationQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("models: no contentUnitDerivationQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from content_unit_derivations")
	}
...
func (o ContentUnitDerivationSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("models: no ContentUnitDerivation slice provided for delete all")
	}
...
func (o ContentUnitDerivationSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from contentUnitDerivation slice")
	}
...
func (o *ContentUnitDerivation) ReloadG() error {
	if o == nil {
		return errors.New("models: no ContentUnitDerivation provided for reload")
	}
...
func (o *ContentUnitDerivationSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("models: empty ContentUnitDerivationSlice provided for reload all")
	}
