...
func (o *AuthorI18n) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("models: unable to update author_i18n, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update author_i18n row")
	}
...
func (q authorI18nQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to update all for author_i18n")
	}
...
func (o AuthorI18nSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update all in authorI18n slice")
	}
...
func (o *AuthorI18n) DeleteG() error {
	if o == nil {
		return errors.New("models: no AuthorI18n provided for deletion")
	}
...
func (o *AuthorI18n) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("models: no AuthorI18n provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete from author_i18n")
	}
...
func (q authorI18nQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("models: no authorI18nQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from author_i18n")
	}
...
func (o AuthorI18nSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("models: no AuthorI18n slice provided for delete all")
	}
...
func (o AuthorI18nSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from authorI18n slice")
	}
...
func (o *AuthorI18n) ReloadG() error {
	if o == nil {
		return errors.New("models: no AuthorI18n provided for reload")
	}
...
func (o *AuthorI18nSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("models: empty AuthorI18nSlice provided for reload all")
	}
