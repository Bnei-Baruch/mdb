...
func (o *ContentRoleType) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("models: unable to update content_role_types, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update content_role_types row")
	}
...
func (q contentRoleTypeQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to update all for content_role_types")
	}
...
func (o ContentRoleTypeSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update all in contentRoleType slice")
	}
...
func (o *ContentRoleType) DeleteG() error {
	if o == nil {
		return errors.New("models: no ContentRoleType provided for deletion")
	}
...
func (o *ContentRoleType) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("models: no ContentRoleType provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete from content_role_types")
	}
...
func (q contentRoleTypeQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("models: no contentRoleTypeQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from content_role_types")
	}
...
func (o ContentRoleTypeSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("models: no ContentRoleType slice provided for delete all")
	}
...
func (o ContentRoleTypeSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from contentRoleType slice")
	}
...
func (o *ContentRoleType) ReloadG() error {
	if o == nil {
		return errors.New("models: no ContentRoleType provided for reload")
	}
...
func (o *ContentRoleTypeSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("models: empty ContentRoleTypeSlice provided for reload all")
	}
