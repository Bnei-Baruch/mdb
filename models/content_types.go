...
func (o *ContentType) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("models: unable to update content_types, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update content_types row")
	}
...
func (q contentTypeQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to update all for content_types")
	}
...
func (o ContentTypeSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update all in contentType slice")
	}
...
func (o *ContentType) DeleteG() error {
	if o == nil {
		return errors.New("models: no ContentType provided for deletion")
	}
...
func (o *ContentType) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("models: no ContentType provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete from content_types")
	}
...
func (q contentTypeQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("models: no contentTypeQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from content_types")
	}
...
func (o ContentTypeSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("models: no ContentType slice provided for delete all")
	}
...
func (o ContentTypeSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from contentType slice")
	}
...
func (o *ContentType) ReloadG() error {
	if o == nil {
		return errors.New("models: no ContentType provided for reload")
	}
...
func (o *ContentTypeSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("models: empty ContentTypeSlice provided for reload all")
	}
