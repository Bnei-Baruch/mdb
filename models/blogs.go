...
func (o *Blog) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("models: unable to update blogs, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update blogs row")
	}
...
func (q blogQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to update all for blogs")
	}
...
func (o BlogSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update all in blog slice")
	}
...
func (o *Blog) DeleteG() error {
	if o == nil {
		return errors.New("models: no Blog provided for deletion")
	}
...
func (o *Blog) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("models: no Blog provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete from blogs")
	}
...
func (q blogQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("models: no blogQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from blogs")
	}
...
func (o BlogSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("models: no Blog slice provided for delete all")
	}
...
func (o BlogSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from blog slice")
	}
