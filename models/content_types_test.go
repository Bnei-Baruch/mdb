...
func testContentTypesInsertWhitelist(t *testing.T) {
	...
	tx := MustTx(boil.Begin())
	defer tx.Rollback()
	if err = contentType.Insert(tx, contentTypeColumnsWithoutDefault...); err != nil {
		t.Error(err)
	}
...
func testContentTypeToManyTypeCollections(t *testing.T) {
	...
	if err = a.L.LoadTypeCollections(tx, false, (*[]*ContentType)(&slice)); err != nil {
		t.Fatal(err)
	}
...
func testContentTypeToManyTypeContentUnits(t *testing.T) {
	...
	slice := ContentTypeSlice{&a}
	if err = a.L.LoadTypeContentUnits(tx, false, (*[]*ContentType)(&slice)); err != nil {
		t.Fatal(err)
	}
