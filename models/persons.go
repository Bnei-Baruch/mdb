...
// SetDescriptionG of the person to the related item.
// Sets o.R.Description to related.
// Adds o to related.R.DescriptionPersons.
// Uses the global database handle.
func (o *Person) SetDescriptionG(insert bool, related *StringTranslation) error {
	return o.SetDescription(boil.GetDB(), insert, related)
}

// SetDescriptionP of the person to the related item.
// Sets o.R.Description to related.
// Adds o to related.R.DescriptionPersons.
// Panics on error.
func (o *Person) SetDescriptionP(exec boil.Executor, insert bool, related *StringTranslation) {
	if err := o.SetDescription(exec, insert, related); err != nil {
		panic(boil.WrapErr(err))
	}
}

// SetDescriptionGP of the person to the related item.
// Sets o.R.Description to related.
// Adds o to related.R.DescriptionPersons.
// Uses the global database handle and panics on error.
func (o *Person) SetDescriptionGP(insert bool, related *StringTranslation) {
...
// Uses the global database handle.
func (o *Person) RemoveDescriptionG(related *StringTranslation) error {
...
// Removes o from all passed in related items' relationships struct (Optional).
// Panics on error.
func (o *Person) RemoveDescriptionP(exec boil.Executor, related *StringTranslation) {
...
// Removes o from all passed in related items' relationships struct (Optional).
// Uses the global database handle and panics on error.
func (o *Person) RemoveDescriptionGP(related *StringTranslation) {
...
// SetNameG of the person to the related item.
// Sets o.R.Name to related.
// Adds o to related.R.NamePersons.
// Uses the global database handle.
func (o *Person) SetNameG(insert bool, related *StringTranslation) error {
	return o.SetName(boil.GetDB(), insert, related)
}

// SetNameP of the person to the related item.
// Sets o.R.Name to related.
// Adds o to related.R.NamePersons.
// Panics on error.
func (o *Person) SetNameP(exec boil.Executor, insert bool, related *StringTranslation) {
	if err := o.SetName(exec, insert, related); err != nil {
		panic(boil.WrapErr(err))
	}
}

// SetNameGP of the person to the related item.
// Sets o.R.Name to related.
// Adds o to related.R.NamePersons.
// Uses the global database handle and panics on error.
func (o *Person) SetNameGP(insert bool, related *StringTranslation) {
