...
func (o *Storage) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("models: unable to update storages, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update storages row")
	}
...
func (q storageQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to update all for storages")
	}
...
func (o StorageSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update all in storage slice")
	}
...
func (o *Storage) DeleteG() error {
	if o == nil {
		return errors.New("models: no Storage provided for deletion")
	}
...
func (o *Storage) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("models: no Storage provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete from storages")
	}
...
func (q storageQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("models: no storageQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from storages")
	}
...
func (o StorageSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("models: no Storage slice provided for delete all")
	}
...
func (o StorageSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from storage slice")
	}
...
func (o *Storage) ReloadG() error {
	if o == nil {
		return errors.New("models: no Storage provided for reload")
	}
...
func (o *StorageSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("models: empty StorageSlice provided for reload all")
	}
