...
var (
	labelDBTypes = map[string]string{`ContentUnitID`: `bigint`, `CreatedAt`: `timestamp with time zone`, `ID`: `bigint`, `MediaType`: `character varying`, `Properties`: `jsonb`, `Secure`: `smallint`, `UID`: `character`}
	_            = bytes.MinRead
)
