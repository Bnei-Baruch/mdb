...
var (
	labelDBTypes = map[string]string{`ApproveState`: `smallint`, `ContentUnitID`: `bigint`, `CreatedAt`: `timestamp with time zone`, `ID`: `bigint`, `MediaType`: `character varying`, `Properties`: `jsonb`, `UID`: `character`}
	_            = bytes.MinRead
)
