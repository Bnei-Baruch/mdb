...
func (o *CollectionsContentUnit) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("models: unable to update collections_content_units, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update collections_content_units row")
	}
...
func (q collectionsContentUnitQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to update all for collections_content_units")
	}
...
func (o CollectionsContentUnitSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update all in collectionsContentUnit slice")
	}
...
func (o *CollectionsContentUnit) DeleteG() error {
	if o == nil {
		return errors.New("models: no CollectionsContentUnit provided for deletion")
	}
...
func (o *CollectionsContentUnit) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("models: no CollectionsContentUnit provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete from collections_content_units")
	}
...
func (q collectionsContentUnitQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("models: no collectionsContentUnitQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from collections_content_units")
	}
...
func (o CollectionsContentUnitSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("models: no CollectionsContentUnit slice provided for delete all")
	}
...
func (o CollectionsContentUnitSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from collectionsContentUnit slice")
	}
...
func (o *CollectionsContentUnit) ReloadG() error {
	if o == nil {
		return errors.New("models: no CollectionsContentUnit provided for reload")
	}
...
func (o *CollectionsContentUnitSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("models: empty CollectionsContentUnitSlice provided for reload all")
	}
