...
// SetDescriptionG of the content_unit to the related item.
// Sets o.R.Description to related.
// Adds o to related.R.DescriptionContentUnits.
// Uses the global database handle.
func (o *ContentUnit) SetDescriptionG(insert bool, related *StringTranslation) error {
	return o.SetDescription(boil.GetDB(), insert, related)
}

// SetDescriptionP of the content_unit to the related item.
// Sets o.R.Description to related.
// Adds o to related.R.DescriptionContentUnits.
// Panics on error.
func (o *ContentUnit) SetDescriptionP(exec boil.Executor, insert bool, related *StringTranslation) {
	if err := o.SetDescription(exec, insert, related); err != nil {
		panic(boil.WrapErr(err))
	}
}

// SetDescriptionGP of the content_unit to the related item.
// Sets o.R.Description to related.
// Adds o to related.R.DescriptionContentUnits.
// Uses the global database handle and panics on error.
func (o *ContentUnit) SetDescriptionGP(insert bool, related *StringTranslation) {
...
// Uses the global database handle.
func (o *ContentUnit) RemoveDescriptionG(related *StringTranslation) error {
...
// Removes o from all passed in related items' relationships struct (Optional).
// Panics on error.
func (o *ContentUnit) RemoveDescriptionP(exec boil.Executor, related *StringTranslation) {
...
// Removes o from all passed in related items' relationships struct (Optional).
// Uses the global database handle and panics on error.
func (o *ContentUnit) RemoveDescriptionGP(related *StringTranslation) {
...
// SetNameG of the content_unit to the related item.
// Sets o.R.Name to related.
// Adds o to related.R.NameContentUnits.
// Uses the global database handle.
func (o *ContentUnit) SetNameG(insert bool, related *StringTranslation) error {
	return o.SetName(boil.GetDB(), insert, related)
}

// SetNameP of the content_unit to the related item.
// Sets o.R.Name to related.
// Adds o to related.R.NameContentUnits.
// Panics on error.
func (o *ContentUnit) SetNameP(exec boil.Executor, insert bool, related *StringTranslation) {
	if err := o.SetName(exec, insert, related); err != nil {
		panic(boil.WrapErr(err))
	}
}

// SetNameGP of the content_unit to the related item.
// Sets o.R.Name to related.
// Adds o to related.R.NameContentUnits.
// Uses the global database handle and panics on error.
func (o *ContentUnit) SetNameGP(insert bool, related *StringTranslation) {
...
func (o *ContentUnit) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("models: unable to update content_units, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update content_units row")
	}
...
func (q contentUnitQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to update all for content_units")
	}
...
func (o ContentUnitSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update all in contentUnit slice")
	}
...
func (o *ContentUnit) DeleteG() error {
	if o == nil {
		return errors.New("models: no ContentUnit provided for deletion")
	}
...
func (o *ContentUnit) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("models: no ContentUnit provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete from content_units")
	}
...
func (q contentUnitQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("models: no contentUnitQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from content_units")
	}
...
func (o ContentUnitSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("models: no ContentUnit slice provided for delete all")
	}
...
func (o ContentUnitSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from contentUnit slice")
	}
...
func (o *ContentUnit) ReloadG() error {
	if o == nil {
		return errors.New("models: no ContentUnit provided for reload")
	}
...
func (o *ContentUnitSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("models: empty ContentUnitSlice provided for reload all")
	}
