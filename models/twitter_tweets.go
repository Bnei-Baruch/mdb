...
func (o *TwitterTweet) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("models: unable to update twitter_tweets, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update twitter_tweets row")
	}
...
func (q twitterTweetQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to update all for twitter_tweets")
	}
...
func (o TwitterTweetSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update all in twitterTweet slice")
	}
...
func (o *TwitterTweet) DeleteG() error {
	if o == nil {
		return errors.New("models: no TwitterTweet provided for deletion")
	}
...
func (o *TwitterTweet) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("models: no TwitterTweet provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete from twitter_tweets")
	}
...
func (q twitterTweetQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("models: no twitterTweetQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from twitter_tweets")
	}
...
func (o TwitterTweetSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("models: no TwitterTweet slice provided for delete all")
	}
...
func (o TwitterTweetSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from twitterTweet slice")
	}
...
func (o *TwitterTweet) ReloadG() error {
	if o == nil {
		return errors.New("models: no TwitterTweet provided for reload")
	}
...
func (o *TwitterTweetSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("models: empty TwitterTweetSlice provided for reload all")
	}
