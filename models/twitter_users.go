...
func (o *TwitterUser) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("models: unable to update twitter_users, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update twitter_users row")
	}
...
func (q twitterUserQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to update all for twitter_users")
	}
...
func (o TwitterUserSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update all in twitterUser slice")
	}
...
func (o *TwitterUser) DeleteG() error {
	if o == nil {
		return errors.New("models: no TwitterUser provided for deletion")
	}
...
func (o *TwitterUser) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("models: no TwitterUser provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete from twitter_users")
	}
...
func (q twitterUserQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("models: no twitterUserQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from twitter_users")
	}
...
func (o TwitterUserSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("models: no TwitterUser slice provided for delete all")
	}
...
func (o TwitterUserSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from twitterUser slice")
	}
...
func (o *TwitterUser) ReloadG() error {
	if o == nil {
		return errors.New("models: no TwitterUser provided for reload")
	}
...
func (o *TwitterUserSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("models: empty TwitterUserSlice provided for reload all")
	}
