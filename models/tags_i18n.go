...
func (q tagsI18nQuery) One() (*TagsI18n, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: failed to execute a one query for tags_i18n")
	}
...
func (q tagsI18nQuery) All() (TagsI18nSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "models: failed to assign all query results to TagsI18n slice")
	}
...
func (q tagsI18nQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to count tags_i18n rows")
	}
...
func (q tagsI18nQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "models: failed to check if tags_i18n exists")
	}
...
func FindTagsI18n(exec boil.Executor, tagID int64, language string, selectCols ...string) (*TagsI18n, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: unable to select from tags_i18n")
	}
...
func (o *TagsI18n) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no tags_i18n provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to insert into tags_i18n")
	}
...
func (o *TagsI18n) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("models: unable to update tags_i18n, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update tags_i18n row")
	}
...
func (q tagsI18nQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to update all for tags_i18n")
	}
...
func (o TagsI18nSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update all in tagsI18n slice")
	}
...
func (o *TagsI18n) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no tags_i18n provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("models: unable to upsert tags_i18n, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert tags_i18n")
	}
...
func (o *TagsI18n) DeleteG() error {
	if o == nil {
		return errors.New("models: no TagsI18n provided for deletion")
	}
...
func (o *TagsI18n) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("models: no TagsI18n provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete from tags_i18n")
	}
...
func (q tagsI18nQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("models: no tagsI18nQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from tags_i18n")
	}
...
func (o TagsI18nSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("models: no TagsI18n slice provided for delete all")
	}
...
func (o TagsI18nSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from tagsI18n slice")
	}
...
func (o *TagsI18n) ReloadG() error {
	if o == nil {
		return errors.New("models: no TagsI18n provided for reload")
	}
...
func (o *TagsI18nSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("models: empty TagsI18nSlice provided for reload all")
	}
...
func (o *TagsI18nSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to reload all in TagsI18nSlice")
	}
...
func TagsI18nExists(exec boil.Executor, tagID int64, language string) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models: unable to check if tags_i18n exists")
	}
