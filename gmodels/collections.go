...
func (q collectionQuery) One() (*Collection, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "gmodels: failed to execute a one query for collections")
	}
...
func (q collectionQuery) All() (CollectionSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "gmodels: failed to assign all query results to Collection slice")
	}
...
func (q collectionQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "gmodels: failed to count collections rows")
	}
...
func (q collectionQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "gmodels: failed to check if collections exists")
	}
...
func FindCollection(exec boil.Executor, id int64, selectCols ...string) (*Collection, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "gmodels: unable to select from collections")
	}
...
func (o *Collection) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("gmodels: no collections provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "gmodels: unable to insert into collections")
	}
...
func (o *Collection) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("gmodels: unable to update collections, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "gmodels: unable to update collections row")
	}
...
func (q collectionQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "gmodels: unable to update all for collections")
	}
...
func (o CollectionSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "gmodels: unable to update all in collection slice")
	}
...
func (o *Collection) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("gmodels: no collections provided for upsert")
	}
	currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("gmodels: unable to upsert collections, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "gmodels: unable to upsert collections")
	}
...
func (o *Collection) DeleteG() error {
	if o == nil {
		return errors.New("gmodels: no Collection provided for deletion")
	}
...
func (o *Collection) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("gmodels: no Collection provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "gmodels: unable to delete from collections")
	}
...
func (q collectionQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("gmodels: no collectionQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "gmodels: unable to delete all from collections")
	}
...
func (o CollectionSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("gmodels: no Collection slice provided for delete all")
	}
...
func (o CollectionSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "gmodels: unable to delete all from collection slice")
	}
...
func (o *Collection) ReloadG() error {
	if o == nil {
		return errors.New("gmodels: no Collection provided for reload")
	}
...
func (o *CollectionSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("gmodels: empty CollectionSlice provided for reload all")
	}
...
func (o *CollectionSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "gmodels: unable to reload all in CollectionSlice")
	}
...
func CollectionExists(exec boil.Executor, id int64) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "gmodels: unable to check if collections exists")
	}
