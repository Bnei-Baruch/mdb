...
func (q contentTypeQuery) One() (*ContentType, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "gmodels: failed to execute a one query for content_types")
	}
...
func (q contentTypeQuery) All() (ContentTypeSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "gmodels: failed to assign all query results to ContentType slice")
	}
...
func (q contentTypeQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "gmodels: failed to count content_types rows")
	}
...
func (q contentTypeQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "gmodels: failed to check if content_types exists")
	}
...
func FindContentType(exec boil.Executor, id int64, selectCols ...string) (*ContentType, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "gmodels: unable to select from content_types")
	}
...
func (o *ContentType) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("gmodels: no content_types provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "gmodels: unable to insert into content_types")
	}
...
func (o *ContentType) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("gmodels: unable to update content_types, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "gmodels: unable to update content_types row")
	}
...
func (q contentTypeQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "gmodels: unable to update all for content_types")
	}
...
func (o ContentTypeSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "gmodels: unable to update all in contentType slice")
	}
...
func (o *ContentType) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("gmodels: no content_types provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("gmodels: unable to upsert content_types, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "gmodels: unable to upsert content_types")
	}
...
func (o *ContentType) DeleteG() error {
	if o == nil {
		return errors.New("gmodels: no ContentType provided for deletion")
	}
...
func (o *ContentType) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("gmodels: no ContentType provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "gmodels: unable to delete from content_types")
	}
...
func (q contentTypeQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("gmodels: no contentTypeQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "gmodels: unable to delete all from content_types")
	}
...
func (o ContentTypeSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("gmodels: no ContentType slice provided for delete all")
	}
...
func (o ContentTypeSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "gmodels: unable to delete all from contentType slice")
	}
...
func (o *ContentType) ReloadG() error {
	if o == nil {
		return errors.New("gmodels: no ContentType provided for reload")
	}
...
func (o *ContentTypeSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("gmodels: empty ContentTypeSlice provided for reload all")
	}
...
func (o *ContentTypeSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "gmodels: unable to reload all in ContentTypeSlice")
	}
...
func ContentTypeExists(exec boil.Executor, id int64) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "gmodels: unable to check if content_types exists")
	}
