...
var (
	tagColumns               = []string{"id", "label_id", "description", "parent_id"}
	tagColumnsWithoutDefault = []string{"label_id", "description", "parent_id"}
...
func (q tagQuery) One() (*Tag, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "gmodels: failed to execute a one query for tags")
	}
...
func (q tagQuery) All() (TagSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "gmodels: failed to assign all query results to Tag slice")
	}
...
func (q tagQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "gmodels: failed to count tags rows")
	}
...
func (q tagQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "gmodels: failed to check if tags exists")
	}
...
func (o *Tag) LabelG(mods ...qm.QueryMod) stringTranslationQuery {
	return o.Label(boil.GetDB(), mods...)
}

// Label pointed to by the foreign key.
func (o *Tag) Label(exec boil.Executor, mods ...qm.QueryMod) stringTranslationQuery {
...
func (tagL) LoadLabel(e boil.Executor, singular bool, maybeTag interface{}) error {
	var slice []*Tag
	var object *Tag
...
// SetLabel of the tag to the related item.
// Sets o.R.Label to related.
// Adds o to related.R.LabelTags.
func (o *Tag) SetLabel(exec boil.Executor, insert bool, related *StringTranslation) error {
	var err error
	if insert {
...
func FindTag(exec boil.Executor, id int64, selectCols ...string) (*Tag, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "gmodels: unable to select from tags")
	}
...
func (o *Tag) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("gmodels: no tags provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "gmodels: unable to insert into tags")
	}
...
func (o *Tag) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("gmodels: unable to update tags, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "gmodels: unable to update tags row")
	}
...
func (q tagQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "gmodels: unable to update all for tags")
	}
...
func (o TagSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "gmodels: unable to update all in tag slice")
	}
...
func (o *Tag) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("gmodels: no tags provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("gmodels: unable to upsert tags, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "gmodels: unable to upsert tags")
	}
...
func (o *Tag) DeleteG() error {
	if o == nil {
		return errors.New("gmodels: no Tag provided for deletion")
	}
...
func (o *Tag) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("gmodels: no Tag provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "gmodels: unable to delete from tags")
	}
...
func (q tagQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("gmodels: no tagQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "gmodels: unable to delete all from tags")
	}
...
func (o TagSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("gmodels: no Tag slice provided for delete all")
	}
...
func (o TagSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "gmodels: unable to delete all from tag slice")
	}
...
func (o *Tag) ReloadG() error {
	if o == nil {
		return errors.New("gmodels: no Tag provided for reload")
	}
...
func (o *TagSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("gmodels: empty TagSlice provided for reload all")
	}
...
func (o *TagSlice) ReloadAll(exec boil.Executor) error {
	...
	err := q.Bind(&tags)
	if err != nil {
		return errors.Wrap(err, "gmodels: unable to reload all in TagSlice")
	}
...
func TagExists(exec boil.Executor, id int64) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "gmodels: unable to check if tags exists")
	}
