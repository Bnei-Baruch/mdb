...
func (q collectionsContentUnitQuery) One() (*CollectionsContentUnit, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "gmodels: failed to execute a one query for collections_content_units")
	}
...
func (q collectionsContentUnitQuery) All() (CollectionsContentUnitSlice, error) {
	var o CollectionsContentUnitSlice

	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "gmodels: failed to assign all query results to CollectionsContentUnit slice")
	}
...
func (q collectionsContentUnitQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "gmodels: failed to count collections_content_units rows")
	}
...
func (q collectionsContentUnitQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "gmodels: failed to check if collections_content_units exists")
	}
...
func (collectionsContentUnitL) LoadCollection(e boil.Executor, singular bool, maybeCollectionsContentUnit interface{}) error {
	...
	if singular {
		...
		slice = *maybeCollectionsContentUnit.(*CollectionsContentUnitSlice)
		count = len(slice)
	}
...
func FindCollectionsContentUnit(exec boil.Executor, collectionID int64, contentUnitID int64, selectCols ...string) (*CollectionsContentUnit, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "gmodels: unable to select from collections_content_units")
	}
...
func (o *CollectionsContentUnit) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("gmodels: no collections_content_units provided for insertion")
	}
	...
	if !cached {
		...
		cache.query = fmt.Sprintf("INSERT INTO \"collections_content_units\" (\"%s\") VALUES (%s)", strings.Join(wl, "\",\""), strmangle.Placeholders(dialect.IndexPlaceholders, len(wl), 1, 1))
	...
	if err != nil {
		return errors.Wrap(err, "gmodels: unable to insert into collections_content_units")
	}
...
func (o *CollectionsContentUnit) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		wl := strmangle.UpdateColumnSet(collectionsContentUnitColumns, collectionsContentUnitPrimaryKeyColumns, whitelist)
		if len(wl) == 0 {
			return errors.New("gmodels: unable to update collections_content_units, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "gmodels: unable to update collections_content_units row")
	}
...
func (q collectionsContentUnitQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "gmodels: unable to update all for collections_content_units")
	}
...
func (o CollectionsContentUnitSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	sql := fmt.Sprintf(
		"UPDATE \"collections_content_units\" SET %s WHERE (\"collection_id\",\"content_unit_id\") IN (%s)",
		strmangle.SetParamNames("\"", "\"", 1, colNames),
		strmangle.Placeholders(dialect.IndexPlaceholders, len(o)*len(collectionsContentUnitPrimaryKeyColumns), len(colNames)+1, len(collectionsContentUnitPrimaryKeyColumns)),
	)
	...
	if err != nil {
		return errors.Wrap(err, "gmodels: unable to update all in collectionsContentUnit slice")
	}
...
func (o *CollectionsContentUnit) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("gmodels: no collections_content_units provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("gmodels: unable to upsert collections_content_units, could not build update column list")
		}
		...
		cache.query = queries.BuildUpsertQueryPostgres(dialect, "\"collections_content_units\"", updateOnConflict, ret, update, conflict, whitelist)

		cache.valueMapping, err = queries.BindMapping(collectionsContentUnitType, collectionsContentUnitMapping, whitelist)
		if err != nil {
			return err
		}
		if len(ret) != 0 {
	...
	if err != nil {
		return errors.Wrap(err, "gmodels: unable to upsert collections_content_units")
	}
...
func (o *CollectionsContentUnit) DeleteG() error {
	if o == nil {
		return errors.New("gmodels: no CollectionsContentUnit provided for deletion")
	}
...
func (o *CollectionsContentUnit) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("gmodels: no CollectionsContentUnit provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "gmodels: unable to delete from collections_content_units")
	}
...
func (q collectionsContentUnitQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("gmodels: no collectionsContentUnitQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "gmodels: unable to delete all from collections_content_units")
	}
...
func (o CollectionsContentUnitSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("gmodels: no CollectionsContentUnit slice provided for delete all")
	}
...
func (o CollectionsContentUnitSlice) DeleteAll(exec boil.Executor) error {
	...
	sql := fmt.Sprintf(
		"DELETE FROM \"collections_content_units\" WHERE (%s) IN (%s)",
		strings.Join(strmangle.IdentQuoteSlice(dialect.LQ, dialect.RQ, collectionsContentUnitPrimaryKeyColumns), ","),
		strmangle.Placeholders(dialect.IndexPlaceholders, len(o)*len(collectionsContentUnitPrimaryKeyColumns), 1, len(collectionsContentUnitPrimaryKeyColumns)),
	)
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "gmodels: unable to delete all from collectionsContentUnit slice")
	}
...
func (o *CollectionsContentUnit) ReloadG() error {
	if o == nil {
		return errors.New("gmodels: no CollectionsContentUnit provided for reload")
	}
...
func (o *CollectionsContentUnitSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("gmodels: empty CollectionsContentUnitSlice provided for reload all")
	}
...
func (o *CollectionsContentUnitSlice) ReloadAll(exec boil.Executor) error {
	...
	sql := fmt.Sprintf(
		"SELECT \"collections_content_units\".* FROM \"collections_content_units\" WHERE (%s) IN (%s)",
		strings.Join(strmangle.IdentQuoteSlice(dialect.LQ, dialect.RQ, collectionsContentUnitPrimaryKeyColumns), ","),
		strmangle.Placeholders(dialect.IndexPlaceholders, len(*o)*len(collectionsContentUnitPrimaryKeyColumns), 1, len(collectionsContentUnitPrimaryKeyColumns)),
	)
	...
	if err != nil {
		return errors.Wrap(err, "gmodels: unable to reload all in CollectionsContentUnitSlice")
	}
...
func CollectionsContentUnitExists(exec boil.Executor, collectionID int64, contentUnitID int64) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "gmodels: unable to check if collections_content_units exists")
	}
