...
ARG mdb_url="postgres://user:password@host.docker.internal/mdb?sslmode=disable"
ARG mdb_test_url="postgres://user:password@host.docker.internal/%s?sslmode=disable"
